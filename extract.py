...
def postgres():
        ...
        connection = psycopg2.connect( database="d6tqr9tjolth23", user='qgiojkehvmogex', password='f29a356850f099b62c0f3eecd3e15bebb3ab54e9b761838a454084848db26fc5', host='ec2-52-18-116-67.eu-west-1.compute.amazonaws.com', port= '5432')
